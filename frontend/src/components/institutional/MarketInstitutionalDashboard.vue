<template>
  <div class="institutional-shell">
    ...
    <template v-else-if="data">
      ...
      <div v-if="showCurrentChipQuickview" class="institutional-section">
...
import InstitutionalCostAnalysis from "./InstitutionalCostAnalysis.vue";
import InstitutionalInsightsSummary from "./InstitutionalInsightsSummary.vue";
import InstitutionalLeaderboards from "./InstitutionalLeaderboards.vue";
import InstitutionalOverviewGrid from "./InstitutionalOverviewGrid.vue";
import InstitutionalPositionTables from "./InstitutionalPositionTables.vue";
import InstitutionalStructuredQueryPanel from "./InstitutionalStructuredQueryPanel.vue";
import InstitutionalTrendPanels from "./InstitutionalTrendPanels.vue";
...
const props = defineProps({
  ...
  showCurrentChipQuickview: { type: Boolean, default: false },
