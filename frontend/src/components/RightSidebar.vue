  ...
  <div class="right-panel">
    ...
    <div v-show="rightTab === 'indicators'" class="rp-content">
      ...
      <div class="ind-group">
        ...
        <div class="ind-row"><div><div class="ind-name">ATR(14)</div></div><div style="display:flex;align-items:center;gap:8px"><div class="ind-val">{{ indicatorSnapshot.atr }}</div></div></div>
        <div class="ind-row"><div><div class="ind-name">CCI(20)</div></div><div style="display:flex;align-items:center;gap:8px"><div class="ind-val">{{ indicatorSnapshot.cci }}</div></div></div>
      </div>
