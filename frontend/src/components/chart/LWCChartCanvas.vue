<template>
  <div class="chart-area lwc-chart-area">
    <div ref="chartContainerEl" class="lwc-chart-host"></div>
...
const props = defineProps({
  ...
  chartContainerTarget: { type: Object, required: true },
...
watchEffect(() => {
  props.chartContainerTarget.target.value = chartContainerEl.value;
});

onBeforeUnmount(() => {
  props.chartContainerTarget.target.value = null;
});
</script>
